    ...
    <main className="min-h-screen bg-black p-6 text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-gray-400">
          Honest feedback se WorkMitra community trusted banti hai.
        </p>
        ...
        <div className="mt-8 rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full rounded-xl bg-yellow-500 p-4 font-bold text-black hover:bg-yellow-400 disabled:opacity-60"
          >
